 ...
 * Generated at: 2024-07-16 01:30:49 UTC
...
public final class lionToken_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  private boolean _jspx_meth_c_005fset_005f0(jakarta.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /jstl/lionToken.jsp(11,1) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fset_005f0.setVar("animals");
      // /jstl/lionToken.jsp(11,1) name = value type = jakarta.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fset_005f0.setValue(new org.apache.jasper.el.JspValueExpression("/jstl/lionToken.jsp(11,1) '토끼, 고양이*강아지, 여우'",_jsp_getExpressionFactory().createValueExpression("토끼, 고양이*강아지, 여우",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
  ...
  private boolean _jspx_meth_c_005fforTokens_005f0(jakarta.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /jstl/lionToken.jsp(15,2) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fforTokens_005f0.setVar("animal");
      // /jstl/lionToken.jsp(15,2) name = items type = jakarta.el.ValueExpression reqTime = true required = true fragment = false deferredValue = true expectedTypeName = java.lang.String deferredMethod = false methodSignature = null
      _jspx_th_c_005fforTokens_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/jstl/lionToken.jsp(15,2) '${animals }'",_jsp_getExpressionFactory().createValueExpression(_jspx_page_context.getELContext(),"${animals }",java.lang.String.class)).getValue(_jspx_page_context.getELContext()));
      // /jstl/lionToken.jsp(15,2) name = delims type = java.lang.String reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      try {
        ...
        if (_jspx_eval_c_005fforTokens_005f0 != jakarta.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            out.write("\r\n");
            out.write("		");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${animal }", java.lang.String.class, (jakarta.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write(" <p>\r\n");
            out.write("	");
